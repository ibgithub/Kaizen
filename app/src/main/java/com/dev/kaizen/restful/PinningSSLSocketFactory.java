...
public class PinningSSLSocketFactory extends SSLSocketFactory {
  ...
  public PinningSSLSocketFactory(String[] pins, long enforceUntilTimestampMillis)
...
//    final SystemKeyStore keyStore             = SystemKeyStore.getInstance(context);
    ...
    final TrustManager[] pinningTrustManagers = initializePinningTrustManagers(pins, enforceUntilTimestampMillis);
...
//    SSLSocketFactory.STRICT_HOSTNAME_VERIFIER.verify(host, sslSocket);
  ...
  private TrustManager[] initializePinningTrustManagers(String[] pins,
                                                        long enforceUntilTimestampMillis)
  {
    final TrustManager[] trustManagers = new TrustManager[1];
    trustManagers[0] = new PinningTrustManager(pins, enforceUntilTimestampMillis);
